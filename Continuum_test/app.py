...
from resources.Conti import Continuum_,ContiList,ContiModel
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:oracle@localhost/Harsh'
...
api.add_resource(ContiList,'/cont')
api.add_resource(Continuum_,'/cont/<string:con_name>')
